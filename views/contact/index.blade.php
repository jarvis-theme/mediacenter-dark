<main id="contact-us" class="inner-bottom-md">
    <section class="google-map map-holder">
        @if($kontak->lat!='0' || $kontak->lng!='0')
            <iframe style="float:right;width:100%" height="460" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=-8.617784,115.222045&amp;aq=&amp;sll={{ $kontak->lat.','.$kontak->lng }}&amp;sspn=0.061695,0.097332&amp;ie=UTF8&amp;t=m&amp;z=14&amp;output=embed"></iframe><br />
        @else
